  ...
  return (
    <body>
        ...
        <div class="right-side">
          ...
          <h3>Technology</h3>
          <br/>  
          <p className='description'>A mini robot puppy ready to be your companion!  libero lectus, a semper elit pretium dignissim. Aliquam a enim ex. Mauris ut aliquam 
