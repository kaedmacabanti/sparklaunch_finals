  ...
  return (
    <body className=''>
        ...
        <div className='px-[5rem] py-[5rem]'> 
            ...
            <h3>Technology</h3>
            <br/> 
            <p className='description'>Giving a 'hand' to the amputees and the born hand-less  libero lectus, a semper elit pretium dignissim. Aliquam a enim ex. Mauris ut aliquam 
