...
import img1 from '../../images/islandskies.jpg';
  ...
  return (
    <body>
        ...
        <div class="right-side">
          <br/>
          <h3>Janella Holmes</h3>
          <br/>
          <h3>Creative</h3>
          <br/>  
          <p className='description'>A wholesome life simulator game where you can collect, farm, customize and explore new lands with cute and fluffy PuffPals!  libero lectus, a semper elit pretium dignissim. Aliquam a enim ex. Mauris ut aliquam 
            sed efficitur faucibus dignissim turpis orci ac purus.</p>
